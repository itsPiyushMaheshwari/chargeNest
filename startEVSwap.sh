...
EVB_SRC_PATH=github.com/chaincode/evBattery
EVO_SRC_PATH=github.com/chaincode/evOwner
EVSS_SRC_PATH=github.com/chaincode/evSwappingStation
EVT_SRC_PATH=github.com/chaincode/evTransaction
